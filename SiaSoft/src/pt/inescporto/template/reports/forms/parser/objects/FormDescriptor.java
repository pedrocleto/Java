 ...
 * Schema.
 * $Id: FormDescriptor.java,v 1.1 2006/09/26 10:07:50 jap Exp $
 */
 ...
 *
 * @version $Revision: 1.1 $ $Date: 2006/09/26 10:07:50 $
 */
public class FormDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public FormDescriptor() {
        ...
        desc.setValidator(fieldValidator);
    } //-- pt.inescporto.template.reports.forms.parser.objects.FormDescriptor()
    ...
    {
        return pt.inescporto.template.reports.forms.parser.objects.Form.class;
