...
public class TmplIntegerEditor extends JTextField implements TableCellEditor {
  protected transient Vector listeners;
  protected transient Integer originalValue;

  public TmplIntegerEditor() {
    super();
...
//    this.setBorder(BorderFactory.createEmptyBorder());
  ...
  public Component getTableCellEditorComponent( JTable table, Object value,
    ...
    if( getText().equals("") )
      ...
      try {
        originalValue = new Integer( getText() );
      }
      catch( Exception ex ) {
  ...
  public Object getCellEditorValue() {
    try {
      return getText().equals("") ? null : new Integer( getText() );
    }
    catch( Exception ex ) {
      JOptionPane.showMessageDialog( this, "Número não válido.", "Erro", JOptionPane.ERROR_MESSAGE );
      return null;
    }
  }
