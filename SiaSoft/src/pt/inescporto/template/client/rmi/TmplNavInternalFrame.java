 ...
 * @version 0.1
 */
public class TmplNavInternalFrame extends TmplBasicInternalFrame implements ActionListener {
  ...
  protected void doSend(int toDo) throws TmplException {
    ...
    try {
      switch (toDo) {
	    ...
	    execMethod.invoke(remote, new Object[] {staticLinkCondition, new Vector()});
	  }
          break;
  ...
  public JComponent[] getDetailsLinks() {
    return detailLinks;
  }
