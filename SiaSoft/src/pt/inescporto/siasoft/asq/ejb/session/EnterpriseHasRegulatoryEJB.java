 ...
 * @version 0.1
 */
public class EnterpriseHasRegulatoryEJB implements SessionBean {
  protected SessionContext ctx;
  protected EnterpriseHasRegulatoryDao attrs = new EnterpriseHasRegulatoryDao();
  protected DAO dao = null;

  public EnterpriseHasRegulatoryEJB() {
    System.out.println("New EnterpriseHasRegulatory Session Bean created by EJB container ...");
    getEJBReferences();
  }
  ...
  public void ejbCreate() {
    dao = new DAO((Object)attrs, "", "java:comp/env/jdbc/siasoft", "EnterpriseHasRegulatory");
  }

  public void ejbCreate(String linkCondition, Vector binds) {
    dao = new DAO((Object)attrs, "", "java:comp/env/jdbc/siasoft", "EnterpriseHasRegulatory", linkCondition, binds);
  }
  ...
  public void delete(EnterpriseHasRegulatoryDao attrs) throws RemoteException, UserException, ConstraintViolatedException {
    try {
      this.attrs = attrs;
      dao.remove(attrs);
    }
  ...
  public void findByPrimaryKey(EnterpriseHasRegulatoryDao attrs) throws RemoteException, RowNotFoundException, UserException {
    try {
      ...
      this.attrs = (EnterpriseHasRegulatoryDao)dao.load(attrs);
    }
    catch (NamingException ex) {
      ctx.setRollbackOnly();
      throw new UserException("Erro no servidor de nomes.", ex);
