 ...
 * @version 0.1
 */
public class SourceEJB implements SessionBean {
  protected SessionContext ctx;
  protected SourceDao attrs = new SourceDao();
  protected DAO dao = null;

  public SourceEJB() {
    System.out.println("New Source Session Bean created by EJB container ...");
    getEJBReferences();
  }
  ...
  public void ejbCreate() {
    dao = new DAO((Object)attrs, "", "java:comp/env/jdbc/siasoft", "source");
  }

  public void ejbCreate(String linkCondition, Vector binds) {
    dao = new DAO((Object)attrs, "", "java:comp/env/jdbc/siasoft", "source", linkCondition, binds);
  }
  ...
  public void setData(SourceDao attrs) {
    this.attrs = attrs;
  }

  public SourceDao getData() {
    return this.attrs;
  }

  public void insert(SourceDao attrs) throws DupKeyException, UserException {
    try {
      this.attrs = attrs;
  ...
  public void update(SourceDao attrs) throws UserException {
    try {
      dao.update(attrs);
    }
    catch (NamingException ex) {
  ...
  public void delete(SourceDao attrs) throws ConstraintViolatedException, UserException {
    try {
      this.attrs = attrs;
      dao.remove(attrs);
    }
  ...
  public void findByPrimaryKey(SourceDao attrs) throws RowNotFoundException, UserException {
    try {
      dao.findByPrimaryKey((Object)attrs);
      this.attrs = (SourceDao)dao.load(attrs);
    }
    catch (NamingException ex) {
      ctx.setRollbackOnly();
      throw new UserException("Erro no servidor de nomes.", ex);
  ...
  public void findNext(SourceDao attrs) throws FinderException, RowNotFoundException {
    try {
  ...
  public void findPrev(SourceDao attrs) throws FinderException, RowNotFoundException {
    try {
  ...
  public String[] lookupDesc(Object[] pkKeys) throws RowNotFoundException {
    try {
      attrs.sourceId.setValue((String)pkKeys[0]);
      findByPrimaryKey(attrs);

      String[] MenuDesc = {attrs.sourceDescription.getValue()};
      return MenuDesc;
    }
    catch (Exception rex) {
