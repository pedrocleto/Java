 ...
 * @version 0.1
 */
public class DocumentEJB implements SessionBean {
  protected SessionContext ctx;
  protected DocumentDao attrs = new DocumentDao();
  protected DAO dao = null;

  public DocumentEJB() {
    System.out.println("New Document Session Bean created by EJB container ...");
    getEJBReferences();
  }
  ...
  public void ejbCreate() {
    dao = new DAO((Object)attrs, "", "java:comp/env/jdbc/siasoft", "Document");
  }

  public void ejbCreate(String linkCondition, Vector binds) {
    dao = new DAO((Object)attrs, "", "java:comp/env/jdbc/siasoft", "Document", linkCondition, binds);
  }
  ...
  public void insert(DocumentDao attrs) throws DupKeyException, UserException {
    try {
      this.attrs = attrs;
  ...
  public void update(DocumentDao attrs) throws UserException {
    try {
      dao.update(attrs);
    }
    catch (NamingException ex) {
  ...
  public void delete(DocumentDao attrs) throws ConstraintViolatedException, UserException {
    try {
      this.attrs = attrs;
      dao.remove(attrs);
    }
  ...
  public void findByPrimaryKey(DocumentDao attrs) throws RowNotFoundException, UserException {
    try {
      dao.findByPrimaryKey((Object)attrs);
      this.attrs = (DocumentDao)dao.load(attrs);
    }
    catch (NamingException ex) {
      ctx.setRollbackOnly();
      throw new UserException("Erro no servidor de nomes.", ex);
  ...
  public void findNext(DocumentDao attrs) throws FinderException, RowNotFoundException {
    try {
  ...
  public void findPrev(DocumentDao attrs) throws FinderException, RowNotFoundException {
    try {
  ...
  public Collection find(DocumentDao attrs) throws FinderException, RowNotFoundException {
    try {
  ...
  public Collection findExact(DocumentDao attrs) throws FinderException, RowNotFoundException {
    try {
  ...
  public String[] lookupDesc(Object[] pkKeys) throws RowNotFoundException {
    try {
      ...
      String[] MenuDesc = {attrs.documentDescription.getValue()};
      return MenuDesc;
    }
    catch (Exception rex) {
