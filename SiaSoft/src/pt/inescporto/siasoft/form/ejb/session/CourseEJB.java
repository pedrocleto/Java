 ...
 * @version 0.1
 */
public class CourseEJB implements SessionBean {
  protected SessionContext ctx;
  protected CourseDao attrs = new CourseDao();
  protected DAO dao = null;

  public CourseEJB() {
    System.out.println("New Course Session Bean created by EJB container ...");
    getEJBReferences();
  }
  ...
  public void ejbCreate() {
    dao = new DAO((Object)attrs, "", "java:comp/env/jdbc/siasoft", "Course");
  }

  public void ejbCreate(String linkCondition, Vector binds) {
    dao = new DAO((Object)attrs, "", "java:comp/env/jdbc/siasoft", "Course", linkCondition, binds);
  }
  ...
  public void insert(CourseDao attrs) throws DupKeyException, UserException {
    try {
      this.attrs = attrs;
  ...
  public void update(CourseDao attrs) throws UserException {
    try {
      dao.update(attrs);
    }
    catch (NamingException ex) {
  ...
  public void delete(CourseDao attrs) throws ConstraintViolatedException, UserException {
    try {
      this.attrs = attrs;
      dao.remove(attrs);
    }
  ...
  public void findByPrimaryKey(CourseDao attrs) throws RowNotFoundException, UserException {
    try {
      dao.findByPrimaryKey((Object)attrs);
      this.attrs = (CourseDao)dao.load(attrs);
    }
    catch (NamingException ex) {
      ctx.setRollbackOnly();
      throw new UserException("Erro no servidor de nomes.", ex);
  ...
  public void findNext(CourseDao attrs) throws FinderException, RowNotFoundException {
    try {
  ...
  public void findPrev(CourseDao attrs) throws FinderException, RowNotFoundException {
    try {
  ...
  public Collection find(CourseDao attrs) throws FinderException, RowNotFoundException {
    try {
  ...
  public Collection findExact(CourseDao attrs) throws FinderException, RowNotFoundException {
    try {
  ...
  public String[] lookupDesc(Object[] pkKeys) throws RowNotFoundException {
    try {
      ...
      String[] MenuDesc = {attrs.courseDescription.getValue()};
      return MenuDesc;
    }
    catch (Exception rex) {
