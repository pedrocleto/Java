 ...
 * @version 0.1
 */
public class CorrectiveActionsDao implements Serializable {
  ...
  public TplString correctiveActionID = new TplString(3, "correctiveActionID", 20, TmplKeyTypes.PKKEY, true);
  public TplString correctiveActionDescription = new TplString(4, "correctiveActionDescription", 512, TmplKeyTypes.NOKEY, true);
