 ...
 * @version 0.1
 */
public class AuditActionsGanttDefinition extends JPanel {
  ...
  AuditActionsGanttDataSource aaDS = new AuditActionsGanttDataSource();
  ...
  public AuditActionsGanttDefinition() {
    initialize();
  }
  ...
  private void initialize() {
    ...
    jlfldAuditAction.setUrl("pt.inescporto.siasoft.go.auditor.ejb.session.AuditActions");
    jlfldAuditAction.setRefFieldList(new JTextField[] {jtfldAuditPlan, jtfldAuditAction});
    ...
    jpnlDummyActions.add(jlfldAuditAction, cc.xyw(6, 6, 3));
    jlfldAuditAction.setEnabled(false);
    ...
    add(new AuditActionsNewGanttChart(aaDS, jbtnUpdate), BorderLayout.CENTER);
  }
