...
public class AuditActionsGanttDataSource implements DataSource{
  ...
  public AuditActionsGanttDataSource(){
  }
 ...
 public void setUp(boolean value) {
   ...
   if (dataSourceListener != null)
     dataSourceListener.tmplRefresh(new TemplateEvent(this));
 }
