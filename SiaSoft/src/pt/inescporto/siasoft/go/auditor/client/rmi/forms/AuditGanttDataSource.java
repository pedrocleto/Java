...
public class AuditGanttDataSource implements DataSource {
  ...
  public void setUp(boolean value) {
    update = value;
    if (dsListener != null)
      dsListener.tmplRefresh(new TemplateEvent(this));
