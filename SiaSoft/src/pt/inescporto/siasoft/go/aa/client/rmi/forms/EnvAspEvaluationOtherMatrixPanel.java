 ...
 * @version 0.1
 */
public class EnvAspEvaluationOtherMatrixPanel extends FW_JPanel {
  ...
  public EnvAspEvaluationOtherMatrixPanel(TplString envAspID) {
    master = new DataSourceRMI("EnvAspOtherMatrixMethod");
    master.setUrl("pt.inescporto.siasoft.go.aa.ejb.session.EnvAspOtherMatrixMethod");
    ...
    allHeaders = new String[] {res.getString("label.envAsp"), res.getString("label.significance"),res.getString("label.significanceDescription"),res.getString("eaevaluationOtherMethod.label.catID"),res.getString("eaevaluationOtherMethod.label.cat1"),res.getString("eaevaluationOtherMethod.label.catID"),res.getString("eaevaluationOtherMethod.label.cat2"),res.getString("eaevaluationOtherMethod.label.catID"),res.getString("eaevaluationOtherMethod.label.cat3"),res.getString("eaevaluationOtherMethod.label.catID"),res.getString("eaevaluationOtherMethod.label.cat3")};
    start();
  }
  ...
  private void jbInit() throws Exception {
    ...
    jPanel.add(new EAEvaluationOtherMatrixMethod(dataSource, this));
  }
