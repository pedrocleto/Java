...
public class MonitorSearchDefinition extends JPanel {
  static ResourceBundle res = ResourceBundle.getBundle("pt.inescporto.siasoft.go.monitor.client.rmi.forms.FormResources");

  MonitorSearchDatasource monSearchDS = new MonitorSearchDatasource();
  ...
  public MonitorSearchDefinition() {
    initialize();
  }
  ...
  private void initialize() {
    ...
    jbtnUpdate.addActionListener(new ActionListener() {
      public void actionPerformed(ActionEvent e) {
	monSearchDS.setNullValues(false);
	if ((!jtfldMonitorDate.getText().equals(" - - ") && !jtfldMonitorEndDate.getText().equals(" - - "))) {
	  if ((jtfldMonitorEndDate.getSelectedDate(true).before(jtfldMonitorDate.getSelectedDate(true))) || (jtfldMonitorEndDate.getSelectedDate(true).equals(jtfldMonitorDate.getSelectedDate(true)))) {
	    ...
	    try {
             monSearchDS.setParameters(new String(MenuSingleton.isSupplier() ? MenuSingleton.getSelectedEnterprise() : MenuSingleton.getEnterprise()),
    ...
    add(new MonitorSearchTable(monSearchDS,jbtnUpdate), BorderLayout.CENTER);
  }
}
