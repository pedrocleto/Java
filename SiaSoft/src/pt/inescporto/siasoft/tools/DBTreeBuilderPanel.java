 ...
 * @version 0.1
 */
public class DBTreeBuilderPanel extends JPanel implements ActionListener, MsgPublisher {
  ...
  public DBTreeBuilderPanel(Connection conn, String catalog, String schema) {
    super(new BorderLayout());

    task = new DBStructBuilder(this, conn, catalog, schema);
