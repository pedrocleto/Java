 ...
 * @version 0.1
 */
public class StructDiffWriterPanel extends JPanel implements ActionListener, MsgPublisher {
  private JProgressBar progressBar;
  private JButton startButton;
  private StructDiffWriter task;
  private JTextArea taskOutput;
  private String newline = "\n";

  public StructDiffWriterPanel(Connection conn, Vector<StatementNode> stmtList) {
    super(new BorderLayout());

    task = new StructDiffWriter(this, conn, stmtList);
